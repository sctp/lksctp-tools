...
struct sk_buff * make_skb(const void *raw, int datalen)
{
        struct sk_buff *nskb;
...
/* Copy an skb.  */
struct sk_buff *skb_copy(const struct sk_buff *skb, unsigned int priority)
{
        struct sk_buff *nskb;
        int datalen;
...
void read_unlock_bh(rwlock_t *rw)
{
        /* DO NOTHING.  */
} /* read_unlock_bh() */
