 ...
 * reassembly support, and SCTP_DISABLE_FRAGMENTS socket option. 
...
main(int argc, char *argv[])
{
	 ...
	 */
	nfrags = ((msg_size/(asoc1->frag_point)) + 
			((msg_size % (asoc1->frag_point)) ? 1 : 0));
	...
	/* Let ip do fragmentation/reassembly by lowering mtu to 1000 */
